...
Na  przedstawiony został ekran logowania, który jest wspólny dla obu aplikacji.

%TODO poszukać o ref do minipage, label do minipage
\begin{figure}[h]
	\centering
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{05/login}
		\caption{Logowanie}
	\end{minipage}
	\hfill
	%\hspace{3cm}
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{05/register}
		\caption{Rejestracja}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{05/menu}
		\caption{Menu główne}
	\end{minipage}
\end{figure}
...
\begin{figure}[h]
	...
	\begin{minipage}[b]{0.35\textwidth}
		\includegraphics[width=\textwidth]{05/tickets}
		\caption{Lista biletów}
	\end{minipage}
	%\hfill
	\hspace{3cm}
	\begin{minipage}[b]{0.35\textwidth}
		\includegraphics[width=\textwidth]{05/buy_ticket}
...
\begin{figure}[h]
	\centering
	\begin{minipage}[b]{0.35\textwidth}
		\includegraphics[width=\textwidth]{05/vehicles}
		\caption{Lista pojazdów}
	\end{minipage}
	%\hfill
	\hspace{3cm}
	\begin{minipage}[b]{0.35\textwidth}
		\includegraphics[width=\textwidth]{05/add_vehicle}
...
\begin{figure}[h]
	\centering
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{05/payment-1}
		\caption{Wybór metody}
	\end{minipage}
	\hfill
	%\hspace{3cm}
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{05/payment-2}
		\caption{Uwierzytelnienie}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{05/payment-3}
...
\begin{figure}[h]
	\centering
	\begin{minipage}[b]{0.35\textwidth}
		\includegraphics[width=\textwidth]{05/scan}
		\caption{Skanowanie}
	\end{minipage}
	%\hfill
	\hspace{3cm}
	\begin{minipage}[b]{0.35\textwidth}
		\includegraphics[width=\textwidth]{05/scan_response}
		\caption{Weryfikacja}
	\end{minipage}
\end{figure}
