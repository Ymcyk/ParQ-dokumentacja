...
% tu można powiedzieć coś o strukturze aplikacji, może o składaniu URL, 

\begin{singlespace}
	\captionof{listing}{Wysłanie żądania z kodem identyfikacyjnym}
	\vspace{0.3cm}
	\inputminted[fontsize=\footnotesize, linenos=true]{xml}{src/imp/url-strings.xml}
\end{singlespace}

%\begin{singlespace}
%	\captionof{listing}{Klasa tworząca URL}
%	\vspace{0.3cm}
%	\inputminted[fontsize=\footnotesize, linenos=true]{java}{src/imp/parq-url.java}
%\end{singlespace}

\subsubsection*{Wysyłanie żądania}

% tu o tym, że w zasadzie wszystkie korzystają z tego samego schematu
% o tokenie, który jest przesyłany w nagłówku
...
% kod uruchomienia kamery i o co w tym chodzi - to embedded
